...
i) the probabilities of the filter statistics given the mean effect size
ii) ranks is TRUE or FALSE to determine how the probabilities will be computed
...
<p style = "text-align: center;"> 
**Figure 2:** Probabilities (A) and weights (B) versus testRanks
</p>
...
Before applying the function let's perform a pre-screening analysis of the data set. Consider the above data set. First make some plots based on the filter statistics, and the pvalues.
...
```
**Figure 3:** (A) Distribution of the filter statistics, (B) distribution of the pvalues, 
(C) relationship between the pvalues and the rank of the filter statistics, and 
(D) empirical cumulative distribution of the pvalues.
